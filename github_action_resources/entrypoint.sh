...
[[ ! -z "$INPUT_EXTERNAL_CHECKS_DIR" ]] && EXTERNAL_CHECKS_DIR_FLAG="--external-checks-dir $EXTERNAL_CHECKS_DIR"
[[ ! -z "$INPUT_OUTPUT_FORMAT" ]] && OUTPUT_FLAG="-o $INPUT_OUTPUT_FORMAT"
[[ ! -z "$INPUT_DOWNLOAD_EXTERNAL_MODULES" ]] && DOWNLOAD_EXTERNAL_MODULES_FLAG="--download-external-modules $DOWNLOAD_EXTERNAL_MODULES"
